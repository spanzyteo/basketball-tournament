                            ...
                            <form action="{{ url('store')}}" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="team1" placeholder="Team One">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Team Two</label>
                                        <input type="text" class="form-control" name="team2" placeholder="Team Two">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="referees" placeholder="Referees">
                                    </div>
